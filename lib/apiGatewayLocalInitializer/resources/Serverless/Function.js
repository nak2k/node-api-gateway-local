...
exports['AWS::Serverless::Function'] = {
  ...
  [END]: (dataRef, context, callback) => {
    ...
    const arn = `arn:local:lambda:${Region}:${AccountId}:function:${FunctionName}`;
    ...
    /*
     * Set the physical Id and attributes.
     */
    dataRef.data.PhysicalId = FunctionName;
    dataRef.data.Attributes = Object.assign(dataRef.data.Attributes || {}, {
      Arn: arn,
    });
